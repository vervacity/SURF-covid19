...
icu_time_series_long_f = icu_time_series_long %>%
  filter(icu_census_ub >= est_icu_beds_available)

icu_time_series_long_f = icu_time_series_long_f %>%
...
wide_icu_excess_demand = as.data.table(dcast(icu_time_series_long_f, County + est_icu_beds_available ~ date, value.var = c('excess_demand')))[est_icu_beds_available>0]
