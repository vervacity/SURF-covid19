             ...
             tabPanel("Documentation",
                      fluidPage(
                        mainPanel(
                          ...
                          br(),
                          a(href="https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(20)30566-3/fulltext", target = '_blank', "[4] 7-day LOS for ICU cases and 12-day LOS for acute cases; Days from symptom onset to hospital admission"),
                          br(),
