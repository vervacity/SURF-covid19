             ...
             tabPanel("Documentation",
                      fluidPage(
                        mainPanel(
                          ...
                          br(),
                          a(href="https://khn.org/news/as-coronavirus-spreads-widely-millions-of-older-americans-live-in-counties-with-no-icu-beds/", "[7] Hospital Bed Data from Kaiser Health News", target = '_blank'),
                          br(),
                          a(href="https://data.chhs.ca.gov/dataset/healthcare-facility-bed-types-and-counts/resource/0997fa8e-ef7c-43f2-8b9a-94672935fa60", "[8] California Hospital Bed Data from California Health and Human Services", target = '_blank'),
                          br(),
                          hr(),
                          h4("Press"),
                          ...
                          br(),
                          a(href="https://www.wsj.com/articles/coronavirus-pandemic-spurs-stanford-researchers-to-create-hospital-resource-calculator-11586251801", "[2] The Wall Street Journal", target = '_blank'),
                          br(),
